...
`FIXTURE_MODE=failure` deliberately fails; `FIXTURE_MODE=wait` waits 180 seconds.
...
The health document reports `fixture-v2`, allowing a response from a stale build
